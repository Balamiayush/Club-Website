    ...
    return (
        <div className='w-full px-4'>
            ...
            <div className="img w-full h-[50vh] lg:h-[90vh] mt-4">
                <img className='w-full h-full object-cover' src="https://scontent.fmey1-1.fna.fbcdn.net/v/t39.30808-6/476284638_122133411470534129_2169891444524222368_n.jpg?stp=cp6_dst-jpg_tt6&_nc_cat=106&ccb=1-7&_nc_sid=833d8c&_nc_ohc=XfphsiPZ5_QQ7kNvwGZKPvh&_nc_oc=AdmeiK0UmJZxzce5P4krPkSnIePj17_uidMi0YfQnMZzr5ahMFv2V0rz0YEBtGtH6os&_nc_zt=23&_nc_ht=scontent.fmey1-1.fna&_nc_gid=FjfQTyUR6sVGNtCU9xRnxg&oh=00_AfEcdPR-1zRZhuA-Y2nu1P0uQAktMlg50ySCk3-GVplghA&oe=6809051C" alt="" />
            </div>
        </div>
    );
}
