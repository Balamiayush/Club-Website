...
const Navbar = ({ products, whitepaper }) => {
    ...
    return (
        <nav className="w-full  h-20  navright transition-all duration-300  z-50  flex justify-between items-center ">
            ...
            <div ref={navRef} className="relative flex items-center bg-[#EEE8FA] rounded-full h-10    z-10">
            ...
            font-[Roobert2]
              relative rounded-full transition-all duration-300 ${activeIndex === index ? "text-white" : "text-black"
                            }`}
                        href="#"
                    >
                        {item}
